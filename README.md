...
|:---------------------|--------------:|--------------:|----------:|----------:|----------:|----------:|-----:|---------:|---------:|-------:|-----------------:|
| **BM_Convert_Sized** |       **100** |   **2.73 µs** |   0.02 µs |   0.01 µs |   2.72 µs |   2.75 µs |    1 |     0.52 |        – |      – |          5.37 KB |
| **BM_Convert_Sized** |     **1,000** |  **66.63 µs** |   0.47 µs |   0.28 µs |  66.09 µs |  66.99 µs |    2 |     8.79 |        – |      – |         90.38 KB |
| **BM_Convert_Sized** |    **10,000** | **264.71 µs** |  18.05 µs |  11.94 µs | 253.76 µs | 282.28 µs |    3 |    83.50 |    19.04 |      – |        845.77 KB |
| **BM_Convert_Sized** |   **100,000** |   **3.97 ms** |  94.88 µs |  62.76 µs |   3.90 ms |   4.08 ms |    4 |   890.63 |   367.19 | 117.19 |      8,427.81 KB |
| **BM_Convert_Sized** | **1,000,000** |   **21.0 ms** | 506.18 µs | 334.81 µs |  20.52 ms |  21.49 ms |    5 | 8,468.75 | 1,437.50 | 625.00 | **85,550.74 KB** |
