...
public class DictionaryLibTests
{
    ...
    {
        using var stream = new MemoryStream(ReadBuiltInZstdBytes(), writable: false);
        return DictionaryLib.DeserializeZstd(stream);
    }
    ...
    [TestMethod]
    public void TestFromZstdPathRejectsNull()
    {
